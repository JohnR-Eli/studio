...
If an original brand is provided or discernible from the image, try to find items from that same brand first, or brands of very similar style and quality. If the original brand is not clear or specified, focus on visual similarity, color, and style to find suitable alternatives.
